...
public class MomentService {
    ...
    private MediaView mediaView(MediaAssetEntity asset){boolean ready=asset.getStatus()==DomainEnums.MediaStatus.READY;return new MediaView(asset.getId(),asset.getKind(),asset.getStatus(),ready?storage.signedGetUrl(asset.getStorageKey(),Duration.ofMinutes(15),asset.getMimeType()):null,ready&&asset.getThumbnailStorageKey()!=null?storage.signedGetUrl(asset.getThumbnailStorageKey(),Duration.ofMinutes(15),"image/webp"):null);}
